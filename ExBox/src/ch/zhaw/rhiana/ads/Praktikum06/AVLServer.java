...
import ch.zhaw.rhiana.ads.Praktikum05.ServerA2;
import ch.zhaw.rhiana.ads.Praktikum06.AVLTree.Node;

public class AVLServer implements CommandExecutor {
	...
	public static void main(String[] args) {
		try {
			String result = new AVLServer().execute(rangliste);
	...
	public String execute(String command) throws Exception {
		...
		AVLTree<Competitor> tree = new AVLTree<Competitor>();
		
		for (Competitor competitor : list) {
			tree.insert(competitor);
		}
